...
●	The chatbot correctly greets the user and identifies the courses, eligibility, fees, application process and documents intents from the keywords present in each 
question.
...
https://colab.research.google.com/drive/1n8OkLsfQiwmSRdwXhZHclqqGyrC9xfla?usp=drive_link
